...
@implementation ZMWorkBrowseViewController
...
-(IBAction)detailClick:(id)sender{
    ...
    NSDictionary* workDict = [workArray objectAtIndex:index];
...
//    [unitDict setValue:[[studentArray objectAtIndex:selectStudentIndex] valueForKey:@"userId"] forKey:@"authorId"];
    ...
    NSString* unitType = [workDict valueForKey:@"unitType"];
...
//    }
    ...
    UITableView* workTableView = [[UITableView alloc] initWithFrame:frame style:UITableViewStylePlain];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (tag == kTagCourseTableView) {
        ...
        NSDictionary* workDict = [workArray objectAtIndex:indexPath.row];
        ...
        [self addLabel:[workDict valueForKey:@"unit"]
                 frame:CGRectMake(160, 10, 140, 30)
                  size:14
              intoView:cell.contentView];
