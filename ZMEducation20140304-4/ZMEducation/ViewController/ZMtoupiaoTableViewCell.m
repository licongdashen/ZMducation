//
//  ZMtoupiaoTableViewCell.m
//  ZMEducation
//
//  Created by Queen on 2017/2/28.
//  Copyright © 2017年 99Bill. All rights reserved.
//

#import "ZMtoupiaoTableViewCell.h"

@implementation ZMtoupiaoTableViewCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        self.se3SelBtn = [[UIButton alloc]initWithFrame:CGRectMake(30, 5, 30, 30)];
