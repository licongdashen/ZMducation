...
#define kTagWordTb 7999

@implementation ZcdQueryWord
    ...
    if([@"M054" isEqualToString:method] && [@"00" isEqualToString:responseCode])
    {
        if (httpId == 1) {
            ...
            if ([dataSourceArr count]>0) {
                ...
                [wordTableView setTag:kTagWordTb];
            ...
            NSArray * prefix = [[NSArray alloc]initWithObjects:@"【本词】",@"【简拼】",@"【读音】",@"【释义】",@"【例句】",@"【同（近）义词】",@"【反义词】", nil];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (tag == kTagWordTb) {
        ...
        NSLog(@"词典：%@",[dataSourceArr objectAtIndex:indexPath.row][0]);
