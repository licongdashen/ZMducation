...
-(id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        
        {
            ...
            bg.image = [UIImage imageNamed:@"bg_textField.png"];
            [self addSubview:bg];
            UITextField * txField3 = [[UITextField alloc]initWithFrame:CGRectMake(135, 130, 125, 47)];
            //txField3.background = [UIImage imageNamed:@"bg_textField.png"];
            txField3.tag = 3;
            txField3.text = @"";
...
-(void)httpEngine:(ZMHttpEngine *)httpEngine didSuccess:(NSDictionary *)responseDict{
    ...
    if([@"M054" isEqualToString:method] && [@"00" isEqualToString:responseCode])
    {
        if (httpId == 1) {
            ...
            CGRect frame = CGRectMake(126, 180, 120, 240);
            ...
            NSArray * prefix = [[NSArray alloc]initWithObjects:@"【标题】",@"【作者】",@"【内容】",@"【注释】",@"【大意】",@"【提示】", nil];
